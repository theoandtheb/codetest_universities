...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference('University.count') do
      post universities_url, params: { university: { alpha_two_code: @university.alpha_two_code, country: @university.country, name: @university.name, state_province: @university.state_province } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { alpha_two_code: @university.alpha_two_code, country: @university.country, name: @university.name, state_province: @university.state_province } }
